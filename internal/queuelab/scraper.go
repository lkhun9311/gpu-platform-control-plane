...
type DeviceScraper struct {
	// Observer and Identity are what the observation will claim about its own provenance. Identity is the
	// exporter's image digest or version: "DCGM said so" is not provenance if nobody can say which DCGM.
